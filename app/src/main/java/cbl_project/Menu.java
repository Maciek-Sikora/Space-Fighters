...
public class Menu {
    ...
    void update() {
        ...
        startButton = new Rectangle(width / 3, height / 4 + scaledButtonOffsetY / 2, width / 3, scaledButtonHeight);
        quitButton = new Rectangle(width / 3, startButton.y + scaledButtonOffsetY, width / 3, scaledButtonHeight);
        helpButton = new Rectangle(width / 3, quitButton.y + scaledButtonOffsetY, width / 3, scaledButtonHeight);
        backButton = new Rectangle(width / 4 + 1, height / 4 + 1, scaledBackButtonSize, scaledBackButtonSize);
    ...
    void drawStartMenu(Graphics2D g2) {
        ...
        g2.drawString("Start", startButton.x + scaledTextOffsetX, startButton.y + scaledTextOffsetY);
        g2.drawString("Quit", quitButton.x + scaledTextOffsetX, quitButton.y + scaledTextOffsetY);
        g2.drawString("Help", helpButton.x + scaledTextOffsetX, helpButton.y + scaledTextOffsetY);
    }
